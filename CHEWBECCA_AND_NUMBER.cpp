...
int main()
{
	...
	cin>>n;
	/* if digit:
	9 then no change but wo pehla digit ni hona chiye
	agar digit 5 se 8 ki range me hai to definitely change as ye
	range digits ko choti banari hai
	ana agar 1 se 4 hai to no change as 9-4 bada bana ra hai digits 
	ko ye range*/
